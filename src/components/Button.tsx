...
const variantStyles = {
  primary:
    'rounded-full bg-[#9cb32e] py-2 px-4 text-sm font-semibold text-white hover:bg-[#b2d838] focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-300/50 active:bg-lime-500',
  secondary:
