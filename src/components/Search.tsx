...
function HighlightQuery({ text, query }: { text: string; query: string }) {
  return (
    <Highlighter
      highlightClassName="group-aria-selected:underline bg-transparent text-lime-600 dark:text-lime-400"
      searchWords={[query]}
      autoEscape={true}
  ...
  return (
    ...
    >
      <div
        id={`${id}-title`}
        aria-hidden="true"
        className="text-sm text-zinc-700 group-aria-selected:text-lime-600 dark:text-zinc-300 dark:group-aria-selected:text-lime-400"
      >
